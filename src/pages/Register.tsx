...
export default function Register() {
  ...
  return (
    <div className={`min-h-screen flex ${isDark ? 'bg-[#0F172A]' : 'bg-[#FAF5FF]'}`}>
      <div className={`hidden lg:flex w-1/2 items-center justify-center relative overflow-hidden ${isDark ? 'bg-gradient-to-br from-[#4C1D95] via-[#5B21B6] to-[#6D28D9]' : 'bg-gradient-to-br from-primary-600 via-primary-500 to-[#A78BFA]'}`}>
      ...
      <div className={`flex-1 flex items-center justify-center p-8 ${isDark ? 'bg-[#0F172A]' : ''}`}>
